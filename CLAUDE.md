...
- Default assumptions: all characters C0, all weapons R1 (user sets R1–R5 per weapon; event weapons show an "R5 obtainable" hint), Lv 90 only (beyond-90 is a roadmap item), talents 1/1/1, KQM Standards artifact stats (manual stat entry is a roadmap item). C/R/talents configurable.
